                    ...
                    {cart && cart.map((item) => (
                        <div key={item._id} className='border d-flex border-2 p-3'>
                            ...
                            <div className='d-flex w-100'>
                                <div className='w-25'>
                                    <img src={item.product_img} alt={item.item_name} />
                                </div>
                                <div className='d-flex flex-column w-75 justify-content-around'>
                                    ...
                                    <div className='d-flex gap-3'>
                                        <div className='d-flex align-items-center'>
                                            QTY:
                                            <button className='ms-2 m-0 px-1  rounded-2 button-qty'>-</button>
                                            <p className='qty-indicator m-0 px-3 border-top border-1 border-black border-bottom'>{item.qty}</p>
                                            <button className='m-0 px-1  rounded-2 button-qty'>+</button>
                                        </div>
                                        <div>
                                    ...
                                    <div>
                                        ...
                                        <h5 className='text-end'>Sub Total: <strong>{item.unit_price}</strong></h5>
                                    </div>
                                </div>
                            </div>
                        </div>
